  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <div className="relative flex justify-center items-center min-h-screen py-8 px-4">
        ...
        <div className="w-full max-w-4xl bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl flex flex-col rounded-2xl shadow-2xl border border-white/20 dark:border-slate-700/50 overflow-hidden h-[90vh] animate-fade-in">
          <Header />
